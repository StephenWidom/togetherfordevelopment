...
<section>
	<div class="container content">
		...
		<div class="leadership">
			...
			?>
			<div class="member">
                    <a title="<?php echo the_sub_field('name'); ?>" href="<?php echo $image['sizes']['large']; ?>"><img src="<?php echo $image['sizes']['medium']; ?>" alt="<?php echo $image['alt']; ?>"></a>
